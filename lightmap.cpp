...
int main(int argc, char** argv)
{
	...
	GLuint programId = LoadProgram("lightmap.vs", "lightmap.fs");
	...
	GLuint textureImage = loadDds("lightmap.DDS");
	...
	bool loaded = LoadObj("room.obj", vertices, uvs, normals);
